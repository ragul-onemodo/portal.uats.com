                ...
                <div class="d-flex flex-wrap align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu to-top dropdown-menu-sm">
                            ...
                            {{-- User info --}}
                            <div
                                class="py-12 px-16 radius-8 bg-primary-50 mb-16
                   d-flex align-items-center justify-content-between gap-2">
                            ...
                            <ul class="to-top-list">
                                ...
                                <li>
                                    <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary
                           ...
                           d-flex align-items-center gap-3"
                                ...
                                <li>
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit"
                                            class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-danger
                               d-flex align-items-center gap-3 bg-transparent border-0">
